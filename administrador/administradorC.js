...
function redirectToConfig() {
    window.location.href = "/paginasTalktome/administrador/administradorEU.html"; // Cambia "configuracion.html" por la ruta de tu archivo de configuración
}

function redirectToEditCourses() {
    window.location.href = "/paginasTalktome/administrador/administradorECU.html"; // Cambia "editar_cursos.html" por la ruta de tu archivo de edición de cursos
}
